...
class Ukontrolpasienmasuk extends CI_Controller {
	...
	public function index(){ 
       ...
       ORDER BY pasienmasuk.namaruangan ASC", array($ruangan, $tanggal))->result();
		...
		$this->load->view('userbangsal/UV_controlpasienmasuk',$data);
    ...
    function edit($id){
		...
		$this->load->view('Auser/sidebar');
		$this->load->view('userbangsal/UV_editpasienmasuk',$data);
		$this->load->view('Auser/footer');
