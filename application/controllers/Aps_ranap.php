...
class Aps_ranap extends CI_Controller {
	...
	public function index(){ 
       ...
       ORDER BY pasienmasuk.namaruangan ASC")->result();
		...
		$this->load->view('admin/V_mobilisasi',$data);
	...
	function edit1($id){
        ...
        $this->load->view('Aadmin/header',$data);
		$this->load->view('Aadmin/sidebar');
		$this->load->view('admin/Vpasiendipindahkan',$data);
		$this->load->view('Aadmin/footer');
	}
	...
	function dipindahkan() {
		...
		$this->session->set_flashdata('success_message', 'Data pasien berhasil dipindahkan.');
...
//================================================================================
	...
	function edit2($id){
        ...
        $this->load->view('Aadmin/header',$data);
		$this->load->view('Aadmin/sidebar');
		$this->load->view('admin/Vpasienpulang',$data);
		$this->load->view('Aadmin/footer');
	}
