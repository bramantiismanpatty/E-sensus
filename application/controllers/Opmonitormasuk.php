...
class Opmonitormasuk extends CI_Controller {
	...
	public function index(){ 
       ...
       ORDER BY pasienmasuk.namaruangan ASC", array($ruangan, $tanggal))->result();
		...
		$this->load->view('operator/VO_monitormasuk',$data);
    ...
    function edit($id){
		...
		$this->load->view('Aoperator/sidebar');
		$this->load->view('operator/VO_editpasienmasuk',$data);
		$this->load->view('Aoperator/footer');
