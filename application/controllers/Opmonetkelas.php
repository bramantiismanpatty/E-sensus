...
class Opmonetkelas extends CI_Controller {
	...
	public function index(){       
       ...
       ORDER BY indikatorkelas.namakelas ASC")->result();
		...
		$this->load->view('operator/VO_lapmonetkelas',$data);
    ...
    function edit($id){
            ...
            $this->load->view('Aoperator/header');
            $this->load->view('Aoperator/sidebar');
            $this->load->view('operator/VO_Editindikatorkelas',$data);	
            $this->load->view('Aoperator/footer');
    }
