...
class VIndikatorruangan extends CI_Controller {
	...
	public function index(){       
       ...
       ORDER BY indikator.namaruangan ASC")->result();
		...
		$this->load->view('visitor/V_indikatorruangan',$data);
    ...
    public function cetak(){
     ...
     FROM indikator 
     WHERE indikator.bulan='$kalender' 
     ORDER BY indikator.ruangan ASC")->result();


      $this->load->view('cetak/indikator_ruang',$data);
