<?php 
class Usensus extends CI_Controller {
    ...
    public function index(){
        ...
        if (!empty($namaruangan) && !empty($tanggal)) {
          ...
          // Jika namaruangan dan tanggal belum dipilih, inisialisasikan $data_monet dengan false
...
//vieww------------------------------------------------------------------------------------------------------------------------      
		...
		$this->load->view('userbangsal/UV_sensus',$data);
    ...
    public function register(){        
        ...
        $data = array (
         ...
         // Cek
         if(empty($tanggal) || empty($namakelas) || empty($koderuangan)) {
