                        ...
                        ?>
                         <div class="card-body">                       
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Aps_masuk') ?>" class="btn btn-success mb-2 ml-2 "><i class="fa fa-plus"></i>Pasien Masuk</a>                    
                                <a href="<?= base_url('Aps_ranap') ?>" class="btn btn-info mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                   
                            </form> 
                        </div>
                        <?php                                 
                            if((isset($_GET['namaruangan'])&& $_GET['namaruangan']!='') && 
		                                ...
		                                <tr>
                                            ...
                                            if (!empty($keluar)) {
                                                ...
                                                foreach ($keluar as $row) {
                                                    ...
                                                    ?>
                                                     <a href="<?= base_url('Aps_ranap/edit1').'/'.$u->id ?>" class="btn btn-warning mb-2 ml-2" onclick="dipindahkan()" ><i class="fa fa-edit"></i>Dipindahkan</a>   
                                                    <a href="<?= base_url('Aps_ranap/edit2').'/'.$u->id ?>" class="btn btn-primary mb-2 ml-auto"><i class="fa fa-edit"></i>Keluar</a>
                                                    <?php
                                                }
                                            } else {
