                            ...
                            <form class = "form-inline"> 
                                ...
                                <?php
                                    ...
                                    ?>                                                                                        
                                        ...
                                        <a href="<?= base_url('Arekapitulasiindikator') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>   
                                <?php
                                    if(count($rekap) > 0) {?>
                                        <a href="<?php echo base_url('Arekapitulasiindikator/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 " target="_blank"> <i class="fa fa-print"></i>catak </a> 
                                <?php
                                    }else{?>                                    
...
<script>
    function openConfirmModal(id) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("ArekapitulasiIndikator/hapus") ?>/' + id);
    }
</script>
