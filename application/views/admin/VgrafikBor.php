            ...
            <div id="content">   
                <div class="container-fluid">       
                    ...
                    <div class="card-header bg-custom-green py-3">
                        ...
                        <div class="card-body">                                       
                         <form class="form-inline" method="GET" action="<?= base_url('Agrumahsakit/generateChart') ?>" target="_blank">
                            ...
                            <a href="<?= base_url('AgRumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                                     
                            <?php if (count($filter) > 0) { ?>
                                <!-- Jika ada data, tampilkan tombol untuk menghasilkan grafik -->               
                                <a href="<?php echo base_url('Agrumahsakit/generateChart?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>"
