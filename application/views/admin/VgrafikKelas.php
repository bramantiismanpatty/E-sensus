            ...
            <div id="content">   
                <div class="container-fluid">       
                    ...
                    <div class="card-header bg-custom-green py-3">
                             <h6 class="m-0 font-weight-bold text-white"> Grafik Statistik Kelas Perawatan</h6>
                        </div>
                        <div class="card-body">                           
                            <!-- <form class="form-inline" method="GET" action="<?= base_url('GrafikKelas_admin/generateChart') ?>" target="_blank">-->
                            <form class="form-inline" method="" action="" target="">                            
                                ...
                                <a href="<?= base_url('Agrafikkelas') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh" aria-hidden="true"></i> refresh</a>                                                                                                      
                                <?php if (count($filter) > 0) { ?>
                                    <!-- Jika ada data, tampilkan tombol untuk menghasilkan grafik -->               
                                    <a href="<?php echo base_url('AGrafikkelas/generateChart?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2" target="_blank">
