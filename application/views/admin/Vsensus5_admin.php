                  ...
                  <div class="card-header bg-custom-green py-3">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('ASensus05') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            
                                <?php if(count($rekap) > 0) {?>
                                    <a href="<?php echo base_url('Asensus05/cetak?namaruangan='.$ruang),'&first_date='.$first_tanggal,'&second_date='.$second_tanggal?>" class="btn btn-success mb-2 ml-2 " target="_blank"> <i class="fa fa-print"></i>catak </a> 
                                 
                                <?php }else{?>
                                    <button type="button" class="btn btn-danger mb-2 ml-2" data-toggle="modal" data-target="#cetakModal"><i class="fa fa-print"></i>Cetak</button>
                                <?php }?>
