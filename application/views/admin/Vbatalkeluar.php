                    ...
                    <div class="card-header bg-custom-green py-3">
                        ...
                        <div class="card-body">                       
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Abatalkeluar') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body m-0 font-weight-bold">
                    Apakah anda yakin akan Membatalkan Pasien keluar Rumah Sakit ?
                </div>
...
<script>
    function openConfirmModal(id_pasienkeluar) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("Abatalkeluar/Batal") ?>/' + id_pasienkeluar);
    }
</script>
