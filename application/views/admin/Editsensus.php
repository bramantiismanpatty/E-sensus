                 ...
                 <div class="card-body p-0">                 
                    ...
                    <div class="row">
                       ...
                       <?php foreach($sensus as $u) :?>
						<form action="<?php echo base_url().'Asensus2/update'; ?>" method="post" class="user">

                            <div class="form-group row">
                                <div class="col-sm-3 mb-3 mb-sm-0">
                                    <label>Kode Ruangan</label>
                                    <input type="hidden" class="form-control" name="id" value="<?php echo $u->id ?>">
                                    <input type="text" class="form-control" name="koderuangan" readonly 
                                    value ="<?php echo $u->koderuangan ?>">
                                </div>
                                <div class="col-sm-3">
                                    <label>Ruang Perwatan</label>
                                    <input type="text" class="form-control" name="namaruangan"readonly 
                                    value ="<?php echo $u->namaruangan ?>">
                                </div>
                                <div class="col-sm-3">
                                    <label>Kelas Perwatan</label>
                                    <input type="text" class="form-control" id="exampleInputEmail"name="namakelas" readonly 
                                ...
                                <div class="col-sm-4 mb-3 mb-sm-0">    
                                    ...
                                    <input type="number" class="form-control" id="keluarharisama" name="masukkeluar" required 
    ...
    jumlahHariPerawatanOutput.value = jumlahHariPerawatan;
                                ...
                                <div class="form-group row">                               
                                    ...
                                    <button class="btn btn-primary btn-user btn-block"type="submit" class="fa fa-save"><b>Update</b></button>
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                                     <div>                                    
                                    <button class="btn btn-dark btn-user btn-block" <?= base_url();'Asensus2'?> class="fa fa-save"><b>Kembali</b></button>
                                     </div>                                
                                </div>                                                                         
                        </form>
                        <?php endforeach; ?>
