                        ...
                        <div class="col-lg-12"></div>
                            <div class="col-lg-12">
                              <div class="p-5">                   
                                    ...
                                    <h1 class="h4 text-gray-900 mb-4">Perbaikan Indikstor Rumah Sakit</h1>
                                     </div>
                                     <?php foreach($rekap as $u) :?>
						<form action="<?php echo base_url().'Arumahsakit/update'; ?>" method="post" class="user">
                            <div class="form-group">
                                <div class="form-group row">
                                    <div class="col-sm-6 mb-3 mb-sm-0"> 
                                    <label>Bulan/Tahun</label>                                      
                                        <input type="hidden" class="form-control form-control-user" name="id" value="<?php echo $u->id ?>">
                                        <input type="text" class="form-control"name="bulan"  required readonly
                                ...
                                <table class="table table-bordered"  width="100%" cellspacing="0">
                                        ...
                                        <tr>
                                            <td>
                                                <select class="form-control" id="periodeHari" name="periode" required>
                                                    <option value="<?php echo $u->periode?>"><?php echo $u->periode?></option>
                                    ...
                                    <table class="table table-bordered table-striped">
                                        ...
                                        <tr>
                                            ...
                                            <td><input type="number" class="form-control" id="hariPerawatan" name="hp" required 
                                                value="<?php echo $u->hp?>"></td>
                                        </tr> 
                                    </table>
                                    <table class="table table-bordered table-striped">
                                        <tr>                                                                                       
                                        ...
                                        <tr>
                                            <td>
                                                <input type="text"  id="jumlahbor"   class="form-control"     name="bor" readonly
                                                value ="<?php echo $u->bor ?>">
                                            </td>
                                            <td>
                                                <input type="text"  id="jumlahavlos" class="form-control "    name="avlos" readonly
                                                value ="<?php echo $u->avlos ?>">
                                            </td>
                                            <td>
                                                <input type="text"  id="jumlahToi"   class="form-control "    name="toi"   readonly   
                                                value ="<?php echo $u->toi ?>">
                                            </td>
                                            <td>
                                                <input type="text"  id="totalBto"    class="form-control"     name="bto"  readonly  
                                                value ="<?php echo $u->bto ?>">
                                            </td>
                                            <td> 
                                                <input type="text"  id="jumlahNdr"   class="form-control "    name="ndr"  readonly
                                                value ="<?php echo $u->ndr ?>">
                                            </td>
                                            <td>
                                            <input type="text"  id="jumlahGdr"   class="form-control "    name="gdr" readonly
                                                value ="<?php echo $u->gdr ?>">
                                            </td>
                                        </tr>
                                    </table>                               
                                </table>
                                <div class="form-group row">                               
                                    ...
                                    <button class="btn btn-primary btn-user btn-block"type="submit" class="fa fa-save"><b>Update</b></button>
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                                     <div>                                    
                                    <button class="btn btn-dark btn-user btn-block" <?= base_url();'Arumahsakit'?> class="fa fa-save"><b>Kembali</b></button>
                                     </div>                                
                                </div>                                                                         
                        </form>
                        <?php endforeach; ?>
...
<script>
   var pasienHidupInput = document.getElementById("pasienhidup");
   var pasienMatiInput = document.getElementById("pasienMati");
   var tempatTidur = <?php echo $u->tidur ?>; // Nilai tempat tidur dari database
   var totalBtoOutput = document.getElementById("totalBto");

   pasienHidupInput.addEventListener("input", hitungTotalBto);
   pasienMatiInput.addEventListener("input", hitungTotalBto);

   function hitungTotalBto() {
       var pasienHidup = parseFloat(pasienHidupInput.value) || 0;
       var pasienMati = parseFloat(pasienMatiInput.value) || 0;

       var jumlahPasien = pasienHidup + pasienMati;
       var totalBto = (jumlahPasien / tempatTidur).toFixed(2);
