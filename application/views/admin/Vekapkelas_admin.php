            ...
            <div id="content">
                ...
                <div class="container-fluid">                    
                    ...
                    <div class="card-header bg-custom-green py-3">
                             <h6 class="m-0 font-weight-bold text-white"> Rekapitulasi Kelas Perawatan Rumah Sakit </h6>
                        </div>
                        <div class="card-body">
                            ...
                            <form class = "form-inline">
                                ...
                                <?php
                                 if(count($rekap) > 0) {?>  
                                  ...
                                  <a href="<?php echo base_url('Arekapitulasikelas/cetak?namakelas='.$kelas),'&bulan='.$bulan,'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-print"></i>catak </a> 
                                    <?php }else{?>   
                            ...
                            <thead>
                                    ...
                                    <td><?php echo $no++ ?></td>                                       	
                                        ...
                                        <!--  <td class="text-center">                
                                           <a href="<?= base_url('Arekapitulasikelas/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>                                            
                                           <a onclick="return confirmDialog()" class="btn btn-info btn-sm" href="<?= base_url('Arekapitulasikelas/hapus').'/'.$u->id ?>">
