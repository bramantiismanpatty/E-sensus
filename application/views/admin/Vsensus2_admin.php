                    ...
                    <div class="card-header bg-custom-green py-3">
                        ...
                        <div class="card-body">                       
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('ASensus02') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
			                      ...
			                      <!--  <th>Option</th> -->   		
		                            ...
		                            <tr>
			                          ...
			                          <td class="text-center">                
                                            <a href="<?= base_url('Asensus2/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a> 
                                            <a onclick="return confirmDialog()" class="btn btn-danger btn-sm" href="<?= base_url('Asensus2/hapus').'/'.$u->id ?>">
