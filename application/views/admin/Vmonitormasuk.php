		                        ...
		                        foreach($masuk as $u){ ?>
		                            <tr>
                                        ...
                                        <td class="text-center">                
                                          <a href="<?= base_url('Amonitormasuk/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
...
<script>
    function openConfirmModal(id) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("Amonitormasuk/hapus_data") ?>/' + id);
    }
</script>
