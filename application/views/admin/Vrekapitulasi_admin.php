                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">                   
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4">Rekapitulasi Data Ruang Perawatan</h1>
                                        </div>
                                        <div class="card-body">                                                                            
                                            <form >
                                        ...
                                        <form action="<?php echo base_url()?>Arekapitulasi/register" method="post" class="user">                               
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped"> 
                                                    <tr>
                                                        <th>Bulan / Tahun</th>
                                            ...
                                            <div class="text-center">
                                             ...
                                             <div class="text-center">
                                                <a class="medium" href="<?= base_url();?>Admin"><b>Kembali</b></a>
                                            </div>
                                            </form> 
                                        </div> 
                                    </div> 
