                    ...
                    <div class="card-header bg-custom-green py-3">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Akontrolpasienmasuk') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            </form> 
                        </div>
                        <?php
		                        ...
		                        foreach($masuk as $u){ ?>
		                            <tr>
                                        ...
                                        <td class="text-center">                
                                          <a href="<?= base_url('Akontrolpasienmasuk/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a> 
                                        </td>
			                        </tr>
			                    <?php                                     
                                }?>                              
