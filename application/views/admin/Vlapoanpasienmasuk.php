                    ...
                    <div class="card-header bg-custom-green py-3">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Apasienmasuk') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            
                                <?php if(count($masuk) > 0) {?>
                                    <a href="<?php echo base_url('Apasienmasuk/cetak?'),'&first_date='.$first_tanggal,'&second_date='.$second_tanggal?>" class="btn btn-success mb-2 ml-2 "target="_blank"> <i class="fa fa-print"></i>catak </a> 
