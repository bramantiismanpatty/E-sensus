                    ...
                    <div class="card-header bg-info py-3">
                            ...
                            <div class="card-body">
                                <form  class = "form-inline" >                                          
                                    ...
                                    <a href="<?= base_url('VperiodeStatistik') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                             
                                     <!--<?php if(count($filter) > 0) {?>                              
                                            <a href="<?php echo base_url('VperiodeStatistik/cetak?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>" class="btn btn-success mb-2 ml-2 ">
                                                <i class="fa fa-print"></i>cetak
                                            </a> 
                                    <?php } else {?>                                               
                                                <button class="btn btn-danger mb-2 ml-2" data-toggle="modal" data-target="#logoutModal"><i class="fa fa-print"></i>Cetak</button>
                                    <?php } ?>--> 
                                    <!-- Menbuat perintah grafik
                                    <?php if(count($filter) > 0) {?>                              
                                            <a href="<?php echo base_url('VperiodeStatistik/grafik?daribulan='.$first_bulan),'&sampbulan='.$second_bulan?>" class="btn btn-success mb-2 ml-2 ">
                                                <i class="fa fa-print"></i>grafik</a>                                                
                                    <?php } else {?>                                        
                                        <button class="btn btn-danger mb-2 ml-2" data-toggle="modal" data-target="#grafikModal">Tampilkan Grafik</button>
                                    <?php } ?>-->                                                                          
                                </form>
                            </div>                
