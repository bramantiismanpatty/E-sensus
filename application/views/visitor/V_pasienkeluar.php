                    ...
                    <div class="card shadow mb-4">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Vpasienpulang') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            
                                <!--  <?php if(count($pulang) > 0) {?>
                                    <a href="<?php echo base_url('Vpasienpulang/cetak?'),'&first_date='.$first_tanggal,'&second_date='.$second_tanggal?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-print"></i>catak </a> 
