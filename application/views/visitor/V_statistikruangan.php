                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Vstatistikruangan') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                                <?php
                                 if(count($rekap) > 0) {?>
                                    <!-- <a href="<?php echo base_url('Vstatistikruangan/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-print"></i>catak </a> -->
                                    <a href="<?php echo base_url('Vstatistikruangan/generateChart?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2" target="_blank">
