                    ...
                    <div class="card-header bg-info py-3">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Vpasienmasuk') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            
                                <!--  <?php if(count($masuk) > 0) {?>
                                    <a href="<?php echo base_url('Vpasienmasuk/cetak?'),'&first_date='.$first_tanggal,'&second_date='.$second_tanggal?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-print"></i>catak </a> 
