            ...
            <div id="content">   
                <div class="container-fluid">       
                    <div class="card mx-auto" style="width:100%">
                        ...
                        <div class="card-body">                                       
                        <form class="form-inline" method="GET" action="<?= base_url('VgRumahsakit/generateChart') ?>" target="_blank">
                            ...
                            <a href="<?= base_url('VgRumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                                     
                            <?php if (count($filter) > 0) { ?>
                                <!-- Jika ada data, tampilkan tombol untuk menghasilkan grafik -->               
                                <a href="<?php echo base_url('VgRumahsakit/generateChart?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>"
