...
<body id="page-top">
                        ...
                        <div class="card-header bg-info py-3">
                            ...
                            <div class="card-body">
                                <form  class = "form-inline" >                                          
                                    ...
                                    <a href="<?= base_url('Vlaporanrumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>
                                     <!--                                                                                         
                                    <?php if(count($filter) > 0) {?>                              
                                            <a href="<?php echo base_url('Vlaporanrumahsakit/cetak?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>" class="btn btn-success mb-2 ml-2 ">
 ...
 <!-- print Modal-->
     <div class="modal fade" id="printModal" tabindex="-1" role="dialog" aria-labelledby="exampleModal"
        aria-hidden="true">
