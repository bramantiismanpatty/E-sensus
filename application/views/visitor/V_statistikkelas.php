                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Vstatistikkelas') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                               
                                <?php
                                 if(count($rekap) > 0) {?>
                                 <!--     <a href="<?php echo base_url('Vstatistikkelas/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-print"></i>catak </a>  -->   
                                    <a href="<?php echo base_url('Vstatistikkelas/generateChart?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2" target="_blank">
