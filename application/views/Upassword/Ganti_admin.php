                            ...
                            <div class="col-lg-12">
                                <div class="p-5">
                                     <div class="text-center">
                                            <h1 class="h4 text-primary-900 mb-4">Ubah Password</h1>
                                     </div>


									<form method="post" action="<?php echo base_url()?>ganti/aksi">
                                   ...
                                   <!--  <div class="text-center">
                                    <a class="btn btn-primary btn-user btn-block" href="<?= base_url();?>admin"><b>Dashboard</b></a>
                            </div> -->
                        </div>
                    </div>
                </div>
