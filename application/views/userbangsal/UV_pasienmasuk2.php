        ...
        <div class="row justify-content-center">
            <div class="col-xl-9 col-lg-9 col-md-12">
                <div class="card o-hidden border-3 shadow-lg my-5">                              
                    ...
                    <div class="card-body">
                        <form action="<?php echo base_url()?>Upasienmasuk2/register" method="post" class="user">
                            ...
                            <table class="table table-bordered table-striped"> 
                                ...
                                <td> 
                                    <input type="date" class="form-control" name="tgl_masuk" required>
                                        ...
                                        <input type="hidden" class="form-control" id="statusPasien" name="status" required readonly
                                        value="baru" > 
                                    </td>    
                                    <td>                                                                                
                                    ...
                                    <td> 
                                        <select class="form-control" id="periodeHari" name="carabayar" required>
                                            ...
                                            <option value="jasaraharja">Jasa Raharja</option>
