                 ...
                 <div class="card-body p-0">                 
                    ...
                    <div class="row">
                       ...
                       <?php foreach($sensus as $u) :?>
						<form action="<?php echo base_url().'Sensus2_userbangsal/update'; ?>" method="post" class="user">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" class="form-control" id="masihdirawat" name="sisa"required
                            ...
                            <div class="form-group row">                                       
                                ...
                                <div class="col-sm-4">
                                    ...
                                    <input type="number" class="form-control" id="jumlahHariPerawatan" name="hp"  
                                    value ="<?php echo $u->hp ?>" >
    ...
    jumlahHariPerawatanOutput.value = jumlahHariPerawatan;
                                ...
                                <div class="form-group row">                               
                                    ...
                                    <button class="btn btn-primary btn-user btn-block"type="submit" class="fa fa-save"><b>Update</b></button>
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                                     <div>                                    
                                    <button class="btn btn-dark btn-user btn-block" <?= base_url();'Sensus2_userbangsal'?> class="fa fa-save"><b>Kembali</b></button>
                                     </div>                                
                                </div>                                                                         
                        </form>
                        <?php endforeach; ?>
