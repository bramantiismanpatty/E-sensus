                        ...
                        <div class="col-lg-12"></div>
                            <div class="col-lg-12">
                              <div class="p-5">                   
                                    ...
                                    <h1 class="h4 text-gray-900 mb-4">Sensus Harian Rawat Inap</h1>
                                     </div><hr>
                                     <div class="card-body">
                                     <?php
                                ...
                                <div class="form-roup-mb-2 ml-3">                                               
                                    <input type='date' class="form-control" name="tanggal"required ></input>                                                   
                                                 ...
                                                 <a href="<?= base_url('Usensus') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a> 
                                    ...
                                    <form action="<?php echo base_url()?>Usensus/register" method="post" class="user">
                                       ...
                                       <hr>
                                        ...
                                        <!-- Tombol simpan dinonaktifkan jika data sudah ada -->
                                            <button class="btn btn-danger btn-user btn-block"type="submit" disabled class="fa fa-save"><b>Telah di approved</b></button>
                                        <?php endif; ?>  
                                    </form>  
                                    <div class="text-center">
                                    <a class="small" href="<?= base_url();?>Userbangsal"><b>Kembali</b></a>
                                    </div>
                                </div>
                            </div>
                        </div>
