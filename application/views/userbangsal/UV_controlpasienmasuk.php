                    ...
                    <div class="card-body">
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Ukontrolpasienmasuk') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            </form> 
                        </div>
                        <?php
		                        ...
		                        foreach($masuk as $u){ ?>
		                            <tr>
                                        ...
                                        <td class="text-center">                
                                          <a href="<?= base_url('Ukontrolpasienmasuk/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>
...
<script>
    function openConfirmModal(id) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("Ukontrolpasienmasuk/hapus_data") ?>/' + id);
    }
</script>
