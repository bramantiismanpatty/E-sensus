 ...
 <div class="container-fluid">                
    <div class="card mx-auto" style="width:49%">
            <div class="card-header py-4">
                <h4 class="m-0 font-weight-bold text-primary text-center">Grafik Bor Rumah Sakit</h4>
            </div>                         
        <form class="form-inline" method="GET" action="<?= base_url('Grumahsakit/generateChart') ?>" target="_blank">
            ...
            <div class="text-center">
                    ...
                    <a href="Grafik_operator" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a> 
    ...
    <script>
        function openNewTab() {
            ...
            form.method = 'GET';
            form.action = '<?= base_url('Grumahsakit/generateChart') ?>';
