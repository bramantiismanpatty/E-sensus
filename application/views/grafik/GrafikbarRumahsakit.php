...
<head>
    ...
    <header>
    <a href="#" id="generate-pdf-link">Generate PDF</a>
        ...
        <div class="container my-auto">
            <div class="copyright text-center my-auto">                     
                <span><h5><b>Grafik Statistik Rumah Sakit</b></h5></span>
...
<body>
    ...
    <script>
        ...
        // JavaScript code to handle click on "Generate PDF" link
        document.getElementById('generate-pdf-link').addEventListener('click', function(event) {
