 ...
 <div class="container-fluid">                
    <div class="card mx-auto" style="width:49%">
            <div class="card-header py-4">
                <h4 class="m-0 font-weight-bold text-primary text-center">Grafik Bor Kelas Perawatan Rumah Sakit</h4>
            </div>                         
        <form class="form-inline" method="GET" action="<?= base_url('Gkelas_owner/generateChart') ?>" target="_blank">
            ...
            <div class="text-center">
                    ...
                    <a href="Gkelas_owner" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a> 
    ...
    <script>
        ...
        <?php foreach ($filter as $u) { ?>
            ...
            labelData.push('<?php echo $u->nama; ?>');
        <?php } ?>
    ...
    <script>
        function openNewTab() {
            ...
            form.method = 'GET';
            form.action = '<?= base_url('Gkelas_owner/generateChart') ?>';
