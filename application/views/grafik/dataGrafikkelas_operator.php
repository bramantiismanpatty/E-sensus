...
<body>
    ...
    <div class="card-body">                           
   <!-- <form class="form-inline" method="GET" action="<?= base_url('GrafikKelas_operator/generateChart') ?>" target="_blank">-->
    <form class="form-inline" method="" action="" target="">
           ...
           (isset($_GET['tahun'])&& $_GET['tahun']!='')){                                       
            ...
            <?php if (count($filter) > 0) { ?>
                ...
                <a href="<?php echo base_url('GrafikKelas_operator/generateChart?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-chart"></i>Tampilkan Grafik </a> 
