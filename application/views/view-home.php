...
<body>
    <div class="w3-bar w3-border w3-light-grey w3-card-4">
        ...
        <?php } if($this->session->userdata('access')=='operator'){ ?>
                <a href="#" class="w3-bar-item w3-button">Daftar Mahasiswa</a>
        <?php } if($this->session->userdata('access')=='owner'){ ?>
                <a href="#" class="w3-bar-item w3-button">Daftar Mata Kuliah</a>                
        <?php }; ?>


        <a href="<?php echo site_url('masuk/logout');?>" class="w3-bar-item w3-button w3-red w3-right">Keluar</a>
    </div>
