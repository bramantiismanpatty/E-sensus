                 ...
                 <div class="card-body p-0">                 
                    ...
                    <div class="row">
                       ...
                       <?php foreach($sensus as $u) :?>
						<form action="<?php echo base_url().'Opsensus2/update'; ?>" method="post" class="user">
    ...
    jumlahHariPerawatanOutput.value = jumlahHariPerawatan;
                                ...
                                <div class="form-group row">                               
                                    ...
                                    <button class="btn btn-primary btn-user btn-block"type="submit" class="fa fa-save"><b>Update</b></button>
                                     ...
                                     &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;    
                                     <div>                                    
                                    <button class="btn btn-dark btn-user btn-block" <?= base_url();'Opsensus2'?> class="fa fa-save"><b>Kembali</b></button>
                                     </div>                                
                                </div>                                                                         
                        </form>
                        <?php endforeach; ?>
