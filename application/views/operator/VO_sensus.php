                              ...
                              <div class="p-5">                   
                                ...
                                <div class="form-roup-mb-2 ml-3">                                               
                                    <input type='date' class="form-control" name="tanggal"required ></input>                                                   
                                                 ...
                                                 <a href="<?= base_url('Opsensus') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a> 
                                    ...
                                    <form action="<?php echo base_url()?>Opsensus/register" method="post" class="user">
