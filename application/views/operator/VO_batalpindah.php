                    ...
                    <div class="card-header bg-custom-samping py-3">
                        ...
                        <div class="card-body">                       
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Opbatalpindah') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
...
<script>
    function openConfirmModal(id) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("Opbatalpindah/hapus_data") ?>/' + id);
    }
</script>
