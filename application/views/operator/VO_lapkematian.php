                    ...
                    <div class="card-header bg-custom-samping py-3">
                        ...
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Oplaporankematian') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                                           
                                <?php
                                 if(count($rekap) > 0) {?>
                                    <a href="<?php echo base_url('Oplaporankematian/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "target="_blank"><i class="fa fa-print"></i>catak </a> 
