                    ...
                    <div class="card-header bg-custom-samping py-3">
                            ...
                            <div class="card-body">
                                <form  class = "form-inline" >                                          
                                    ...
                                    <a href="<?= base_url('OPlaporanrumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                                           
                                    <?php if(count($filter) > 0) {?>                              
                                            <a href="<?php echo base_url('OPlaporanrumahsakit/cetak?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>" class="btn btn-success mb-2 ml-2 "target="_blank">
