                            ...
                            <div class="col-lg-12"></div>
                                ...
                                <div class="p-5">                   
                                    <div class="text-center">
                                        <h1 class="h4 text-gray-900 mb-4"> Hitung Indikator Rumah Sakit</h1>
                                    </div>
                                    <div class="card-body">  
                                        <form>
                                                ...
                                                <table class="table table-bordered table-striped"> 
                                                    ...
                                                    <tr>
                                                        <td colspan="4">
                                                            ...
                                                            <a href="<?= base_url('Opdatarumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>Refresh</a>                                                                             
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                    ...
                                    <form action="<?php echo base_url()?>Opdatarumahsakit/register" method="post" class="user">
                                    <?php if(isset($hasil_rekap) && $hasil_rekap !== false): ?>  
                                        <div class="table-responsive">                             
                                            ...
                                            <hr>
                                            <div class="text-center">
                                            <?php if (!$data_monet && $bulan !== 'tidak ada di pilih'): ?>
                                            ...
                                            <?php elseif ($data_monet && $bulan === 'tidak ada di pilih'): ?>
