                    ...
                    <div class="card-header bg-custom-samping py-3">
                        ...
                        <div class="card-body">
                            <form  class = "form-inline" >                                          
                                ...
                                <a href="<?= base_url('Oprumahsakit') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                                           
                                <!-- 
                                <?php if(count($filter) > 0) {?>                              
                                        <a href="<?php echo base_url('Oprumahsakit/cetak?daribulan='.$daribulan),'&daritahun='.$daritahun,'&sampbulan='.$sampbulan,'&samptahun='.$samptahun?>" 
                                        class="btn btn-success mb-2 ml-2 " target="_blank" ><i class="fa fa-print"></i>cetak
                                        </a> 
                                <?php } else {?>                                            
     ...
     <div class="modal fade" id="grafikModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalGrafik"
        ...
        <div class="modal-dialog" role="document">
            ...
            <div class="modal-header bg-info py-3">
                ...
                <div class="modal-body m-0 font-weight-bold">
                    Data Tidak Ada untuk di tampilkan pada grafik..!!</div>
                <div class="modal-footer">
                    <button class="btn btn-danger" type="button" data-dismiss="modal">OK</button>
