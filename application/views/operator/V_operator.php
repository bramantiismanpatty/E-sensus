        ...
        <div id="content-wrapper" class="d-flex flex-column">           
            <div id="content">              
                ...
                <div class="container-fluid">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                           ...
                                           <b> Petugas Sensus Ruangan</b>
                                           <b></b></div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800"><?php echo $Jsandi; ?></div>
                                        </div>
                    ...
                    <label class="perhatian" align="center" style="color: red;"><h4>PERHATIAN!</h4></label>
                    <?php
