            ...
            <div id="content">
                ...
                <div class="container-fluid">                    
                    ...
                    <div class="card-header bg-custom-samping py-3">
                             <h6 class="m-0 font-weight-bold text-white">  Hitung Indikator Kelas </h6>
                        </div>
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                ?>                                                                                        
                                <button type="submit" class="btn btn-primary mb-2 ml-auto "><i class="fa fa-eye"></i>Hitung</button>
                                    <a href="<?= base_url('Oprekapitulasikelas') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>Refresh</a>                               
                                 <!-- 
                                <?php
                                 if(count($rekap) > 0) {?>
                                    <a href="<?php echo base_url('Oprekapitulasikelas/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 " target="_blank" > <i class="fa fa-print"></i>catak </a>                                
                                <?php }else{?>                                    
                                    <a class="btn btn-danger mb-2 ml-2"  href="#" data-toggle="modal" data-target="#kelasModal"> <i class="fa fa-print"></i>Cetak </a>
                                <?php }?>
                                -->
                            </form> 
                        </div>
                                ...
                                <thead>
				                    ...
				                    -->    
                                         <!--   <td class="text-center">                
                                           <a href="<?= base_url('Oprekapitulasikelas/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>                                            
...
<script>
    function openConfirmModal(id_pasienkeluar) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("Oprekapitulasikelas/hapus") ?>/' + id);
    }
</script>
