            ...
            <div id="content">
                ...
                <div class="container-fluid">                    
                    ...
                    <div class="card-header bg-custom-samping py-3">
                             <h6 class="m-0 font-weight-bold text-white"> Laporan Pasien Keluar Rawat Inap</h6>
                        </div>
                        <div class="card-body">
                        <?php
                        ...
                        ?>
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Oppasienkeluar') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                            
                            
                                 <?php if(count($pulang) > 0) {?>
                                    <a href="<?php echo base_url('Oppasienkeluar/cetak?'),'&first_date='.$first_tanggal,'&second_date='.$second_tanggal?>" class="btn btn-success mb-2 ml-2 "target="_blank" ><i class="fa fa-print"></i>catak </a> 
