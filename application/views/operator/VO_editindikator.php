                        ...
                        <div class="col-lg-12"></div>
                            <div class="col-lg-12">
                              <div class="p-5">                   
                                    ...
                                    <h1 class="h4 text-gray-900 mb-4">Perbaikan Indikator Ruang Rawat Inap</h1>
                                     </div>
                                     <?php foreach($rekap as $u) :?>
						            <form action="<?php echo base_url().'OprekapitulasiIndikator/update';?>" method="post" class="user">
                                        <div class="form-group">
                                            <div class="form-group row">
                                                <div class="col-sm-6 mb-3 mb-sm-0"> 
                                                    <label>Kode Ruangan</label>                                      
                                                    <input type="hidden" class="form-control form-control-user" name="id" value="<?php echo $u->id ?>">
                                                    <input type="text" class="form-control form-control-user" name="koderuangan"required readonly
                                                        value ="<?php echo $u->koderuangan ?>">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label>Ruangan Perawatan</label> 
                                                    <input type="text" class="form-control form-control-user" name="namaruangan"required readonly
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="hidden" class="form-control"name="bulan"  required readonly
                                            ...
                                            <table class="table table-bordered"  width="100%" cellspacing="0">
                                                    <table class="table table-bordered table-striped"> 
                                                        ...
                                                        <tr>
                                                            <td>
                                                            <input type="number" class="form-control" id="periodeHari" name="periode" required readonly
                                            ...
                                            <div>   
                                                ...
                                                <div class="text-center">                                  
                                                <a class="medium" href="<?= base_url();?>OprekapitulasiIndikator"><b>Kembali</b></a>
                                            </div>                                
                                        </div>                                                                                
                                    </form>
                                    <?php endforeach; ?>
