<body class="bg-gradient-primary">
                                ...
                                <div class="col-lg-12">
                                    <div class="p-5">                   
                                        <div class="text-center">
                                            <h1 class="h4 text-gray-900 mb-4"> Hitung Indikator Ruang Perawatan</h1>
                                        </div>
                                        <div class="card-body">                                                                            
                                            <form >
                                                <div class="table-responsive">
                                                    <table class="table table-bordered table-striped"> 
                                                        ...
                                                        <tr>
                                                         ...
                                                         <tr>
                                                            <td colspan="4">
                                                                <button type="submit" class="btn btn-primary mb-2"><i class='fas fa-pen'></i>Proses</button> 
                                                                <a href="<?= base_url('Oprekapitulasi') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>Refresh</a>                                                                             
                                                            </td>
                                                        </tr>
                                                    </table>
                                                </div>
                                        ...
                                        <div class="alert alert-info">
                                                Memilih Ruangan :<span class="font-weight-bold"><?php echo $namaruangan?> </span> Bulan :<span class="font-weight-bold"><?php echo $kalender?>
                                        </div>                           
                                        <form action="<?php echo base_url()?>Oprekapitulasi/register" method="post" class="user">                               
                                            <div class="table-responsive">
                                                <table class="table table-bordered table-striped"> 
                                                    <tr>
                                                        <th>Bulan / Tahun</th>
                                                        <th>kode Ruangan Perawatan</th>
                                                    ...
                                                    <?php foreach($rekap as $u) :?> 
                                                        ...
                                                        <td> 
                                                        <input type="text" class="form-control" readonly id="tempatTidur" name="tidur" required value="<?php echo $u->tidur?>">
                                                        </td>
                                                    <?php endforeach ?> <hr> 
                                                ...
                                                <table class="table table-bordered table-striped"> 
                                                    ...
                                                    <tr>
                                                        <td> 
                                                            <input type="number" class="form-control" name="masuk" required readonly
                                                ...
                                                <table class="table table-bordered table-striped"> 
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>                                         
                                                            <input type="text" class="form-control" id="periodeHari" name="periode" required readonly value="-">                                        
                                                        </td>                                        
                                                    </tr>
                                                </table>
                                                <?php else: ?>
                                                    <p>Belum ada Bulan dan Ruangan yang dipilih.</p>
                                                <?php endif; ?>
                                                <table class="table table-bordered table-striped"> 
                                                    <tr>
                                                        <th>BOR</th>
                                            ...
                                            <hr>
                                            <!-- <?php if (!$data_monet && $namaruangan !== 'tidak ada di pilih'): ?>
                                            ...
                                            <?php elseif ($data_monet && $namaruangan === 'tidak ada di pilih'): ?>
                                            ...
                                            <div class="text-center">
                                                <a class="medium" href="<?= base_url();?>operator"><b>Kembali</b></a>
                                            </div>
                                        </div> 
                                    </div> 
                                </div>                              
    ...
    <script>
    // Fungsi untuk mendapatkan jumlah hari dalam bulan tertentu berdasarkan tahun dan bulan
