                        ...
                        ?>
                            ...
                            <form class = "form-inline"> 
                                ...
                                <?php if(count($bangsal) > 0) {?>
                                    <a href="<?php echo base_url('Opbangsal/cetak?koderuangan='.$ruang),'&bulan='.$bulan,'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2" target="_blank"> <i class="fa fa-print"></i>catak </a> 
