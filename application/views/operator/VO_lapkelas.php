                    ...
                    <div class="card-header bg-custom-samping py-3">
                        ...
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Oplaporankelas') ?>" class="btn btn-success mb-2 ml-2 " target="_blank"> <i class="fa fa-refresh"></i>refresh</a>                                
                                 <?php
                                 if(count($rekap) > 0) {?>
                                    <a href="<?php echo base_url('Oplaporankelas/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "target="_blank" > <i class="fa fa-print"></i>catak </a> 
                                  ...
                                  <!--  <th>Periode</th> 
				                    ...
				                    -->    
                                     <!--  <td class="text-center">                
                                           <a href="<?= base_url('Oplaporankelas/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>                                            
                                           <a onclick="return confirmDialog()" class="btn btn-info btn-sm" href="<?= base_url('Oplaporankelas/hapus').'/'.$u->id ?>">
