            ...
            <div id="content">             
                <div class="container-fluid">       
                    ...
                    <div class="card-header bg-custom-samping py-3">
                             <h6 class="m-0 font-weight-bold text-white"> Rekapitulasi Indikator Ruang Perawatan </h6>
                        </div>
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <?php
                                    ...
                                    ?>                                                                                        
                                        ...
                                        <a href="<?= base_url('OprekapitulasiIndikator') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a> 
                                 <!--  
                                <?php                                
                                    if(count($rekap) > 0) {?>
                                        <a href="<?php echo base_url('OprekapitulasiIndikator/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 " target="_blank" >
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="text-center">                
                                           <a href="<?= base_url('OprekapitulasiIndikator/edit').'/'.$u->id ?>" class="btn btn-warning btn-sm"><i class="fa fa-edit"></i></a>  
                                            <!--                                       
...
<script>
    function openConfirmModal(id) {
        ...
        $('#confirmButton').attr('href', '<?= base_url("OprekapitulasiIndikator/hapus") ?>/' + id);
    }
</script>
