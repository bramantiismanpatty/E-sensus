            ...
            <div id="content"> 
                <div class="container-fluid">        
                    ...
                    <div class="card-header bg-custom-samping py-3">
                             <h6 class="m-0 font-weight-bold text-white"> Statistik Ruangan Perawatan </h6>
                        </div>
                        <div class="card-body">
                            <form class = "form-inline"> 
                                ...
                                <a href="<?= base_url('Opstatistikruangan') ?>" class="btn btn-success mb-2 ml-2 "> <i class="fa fa-refresh"></i>refresh</a>                                                                             
                                <?php
                                 if(count($rekap) > 0) {?>
                                    <a href="<?php echo base_url('Opstatistikruangan/cetak?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2 "target="_blank"> <i class="fa fa-print"></i>catak </a> 
                                    <a href="<?php echo base_url('Opstatistikruangan/generateChart?bulan='.$bulan),'&tahun='.$tahun?>" class="btn btn-success mb-2 ml-2" target="_blank">
                                    <i class="fa fa-line-chart"></i> Tampilkan Grafik</a>
                                    <?php }else{?>                                    
